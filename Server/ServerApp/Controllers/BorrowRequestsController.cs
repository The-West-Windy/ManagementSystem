...
namespace ServerApp.Controllers
{
    ...
    public class BorrowRequestsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,LibrarianID,BookID,RequestDate,Status,BorrowerName,Notes")] BorrowRequest borrowRequest)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,LibrarianID,BookID,RequestDate,Status,BorrowerName,Notes")] BorrowRequest borrowRequest)
        {
